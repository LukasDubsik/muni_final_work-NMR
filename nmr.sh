...
if [[ $input_type == "mol2" ]]; then
    ...
    obabel -imol2 inputs/structures/${name}.mol2 -oxyz -O process/reparations/crest/${name}.xyz > /dev/null 2>&1 || { echo -e "\t\t\t[$CROSS] ${RED} Failed to convert mol2 to xyz format!${NC}"; exit 1; }
